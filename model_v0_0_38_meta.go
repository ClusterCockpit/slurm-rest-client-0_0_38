...
type V0038Meta struct {
	Plugin *V0038MetaPlugin `json:"plugin,omitempty"`
...
// SetPlugin gets a reference to the given V0038MetaPlugin and assigns it to the Plugin field.
